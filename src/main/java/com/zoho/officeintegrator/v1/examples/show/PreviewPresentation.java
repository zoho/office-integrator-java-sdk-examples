	...
	public static void main(String args[]) {
		...
		try {
			...
			if ( responseStatusCode >= 200 && responseStatusCode <= 299 ) {
				...
				LOGGER.log(Level.INFO, "Preview Session Creation API configuration error - {0} error code - {1} key - {2} param name - {3}", new Object[] { errorMessage, errorCode, errorKeyName, errorParameterName }); //No I18N
			}
